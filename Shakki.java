...
//Jostain syyst� tallennus onnistuu (siis serialized-tiedosto luodaan), mutta tiedostoa ei saa luettua.
public class Shakki{
  public static void main(String[] args){
    ...
    System.out.println("Tervetuloa pelaamaan shakkia!");
     ...
     while (peliKaynnissa) {
      ...
      if ((n.charAt(0)==quit.charAt(0))||(m.charAt(0)==quit.charAt(0))){
          System.out.println("Tallennetaanko peli (Y/Mitä vain)?");
          String kylla = "Y";
          String tallennanna = sc.nextLine();
          if (tallennanna.charAt(0) == kylla.charAt(0)){
            tallenna(lauta);
            break;
          }
...
public static void tallenna(Nappula[][] lauta){
  ...
  try{ 
  FileOutputStream fos = new FileOutputStream("C:\\Users\\leora\\OneDrive\\Asiakirjat\\Javat\\Shakki\\Chess-MarttaY-patch-1\\shakki1.ser");
...
public static Nappula[][] lataaTallennus(Nappula[][] lauta){ 
  try{FileInputStream fis = new FileInputStream("C:\\Users\\leora\\OneDrive\\Asiakirjat\\Javat\\Shakki\\Chess-MarttaY-patch-1\\shakki1.ser");
  ...
  return lauta;
    ...
    System.out.println("Tallennusta ei ole!");
    return lauta;
  }
}
}
